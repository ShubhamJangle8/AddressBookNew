		...
		while (true) {
			...
			switch (v) {
				...
				case 10:
					System.out.println("Enter the city");
					city = scanner.nextLine();
					addressBookMain.countPersonsByCity(city);
					break;
				case 11:
					System.out.println("Enter the state");
					state = scanner.nextLine();
					addressBookMain.countPersonsByState(state);
					break;
				case 12:
				...
				case 13:
					...
					break;
				case 14:
					addressBookMain.writeData(IOService.FILE_IO);
					break;
				case 15:
					addressBookMain.readData(IOService.FILE_IO);
					break;
				case 16:
					addressBookMain.writeDataCSV(IOService.FILE_IO);
					break;
				case 17:
					addressBookMain.readDataCSV(IOService.FILE_IO);
					break;
				case 18:
					addressBookMain.writeDataGSON(IOService.FILE_IO);
					break;
				case 19:
					addressBookMain.readDataGSON(IOService.FILE_IO);
					break;
				case 20:
					System.exit(0);
					break;
